		...
		<main className="min-h-dvh bg-[#24100a] text-[#f8e8c8]">
			<section className="relative min-h-[82dvh] overflow-hidden bg-cover bg-center px-5 py-16 sm:px-10" style={{ backgroundImage: `url(${estante})` }}>
				...
				<div className="relative mx-auto max-w-6xl">
					<div className="mb-9 flex flex-wrap items-end justify-between gap-4"><div><p className="text-xs uppercase tracking-[.35em] text-[#e5b15a]">Coleção DreamPages</p><h1 className="font-island text-7xl leading-none text-[#ffe9b0]">Nossa estante</h1></div><button type="button" onClick={() => onNavigate?.('home')} className="border border-[#ddb15e] px-5 py-2 text-xs uppercase tracking-[.2em] text-[#ffe9b0] hover:bg-[#5c1b0c]">Voltar</button></div>
